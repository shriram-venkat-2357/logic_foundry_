...
module tb_channel_top;
    ...
    initial begin
        // Create waves directory if needed and open dump file
        ...
        // Send 16 packets (matches RX output count in expected results)
        for (int i = 0; i < 16; i++) begin
            lf_tx_data_i = 16'hAAAA ^ (i << 4); // More distinct data patterns
            lf_tx_valid_i = 1;
        ...
        repeat (30) @(posedge lf_clk_i); // Increased delay to see all outputs
